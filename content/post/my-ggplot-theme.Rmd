...
The classic choice isn't bad; has a clean feel that says, "I'm ready for a look". But making your own theme isn't that hard, and the results can be more rewarding. Of co[^1]urse, packages like `ggthemes` and `hrbrthemes`[^1] exist, but again, it isn't that hard to do yourself.
